...
If using this language service outside of VS Code (e.g. in Vim), it is not necessary for the language client to forward the telemetry events sent by the server to the client.
